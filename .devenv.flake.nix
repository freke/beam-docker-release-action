{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/david/Projects/beam-docker-release-action";
  project_input_ref = "path:/home/david/Projects/beam-docker-release-action";
  devenv_dotfile = "/home/david/Projects/beam-docker-release-action/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1001";
  devenv_runtime = "/run/user/1001/devenv-e46342e";
  ...
  hostname = "archlinux";
  username = "david";
  git_root = "/home/david/Projects/beam-docker-release-action";
  secretspec = null;
};
    in
    {
